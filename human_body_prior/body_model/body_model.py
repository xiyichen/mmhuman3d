...
class BodyModel(nn.Module):
    ...
    def __init__(self,
        ...
        # shapedirs = smpl_dict['shapedirs'][:, :, :num_betas].astype(np.float32)
        # print(shapedirs)
        shapedirs = np.load('/gammascratch/xiyichen/3dgs-avatar-release/body_models/misc/shapedirs_all.npz')['neutral']
